  ...
  return (
    <div className="min-h-screen bg-cover bg-center relative overflow-hidden" style={{ backgroundImage: "url('https://flux-image.com/_next/image?url=https%3A%2F%2Fai.flux-image.com%2Fflux%2Fdae7c915-8cee-43e5-9663-70ebc0ea7133.png&w=3840&q=75')" }}>
      ...
      <button
        ...
        className="absolute top-6 right-6 px-4 py-2 bg-green-400 text-white rounded-lg border border-white/40 shadow-md hover:opacity-90 transition duration-300 flex items-center gap-2 sm:top-8 sm:right-8 sm:px-6 sm:py-3"
      >
      ...
      <div className="absolute top-6 left-6 px-4 py-2 bg-white/20 backdrop-blur-lg rounded-lg border border-white/40 flex items-center gap-2 sm:top-12 sm:left-12 sm:px-6 sm:py-4">
        {/* User Icon */}
      ...
      <div className="absolute bottom-24 left-6 px-4 py-2 bg-white/20 backdrop-blur-lg rounded-lg border border-white/40 flex items-center gap-2 sm:bottom-20 sm:left-12 sm:px-6 sm:py-4">
        {/* Panda Icon */}
        <img src="https://www.pngkit.com/png/full/0-6264_panda-bear-panda-head-png.png" alt="Panda" className="w-6 h-6" />
      ...
      <div className="absolute bottom-24 right-6 px-4 py-2 bg-white/20 backdrop-blur-lg rounded-lg border border-white/40 flex items-center gap-2 sm:bottom-20 sm:right-12 sm:px-6 sm:py-4">
